...
team_members2 = [
    ...
    {"name": "Keerthic Aswin", "photo": "pages/images/Aswin.jpg", "linkedin": "#", "twitter": "https://x.com/keerthic_aswin", "github": "#"},
...
for i in range(1):
    with cols_lead1[0]: 
        ...
        # Display Team Lead Separately
            ...
            st.markdown(f'<p class="team_lead">{team_lead["name"]}</p>', unsafe_allow_html=True)
